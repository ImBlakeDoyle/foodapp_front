...
function HomePage() {
    return(
        <div className="home-container">
            ...
            <h1 id="title"><span id="title-emoji">🍌</span>This<span className="title-emoji">🍩</span>Is<span className="title-emoji">🍳</span>Blake's<span className="title-emoji">🍔</span>Food<span className="title-emoji">🥜</span>App<span className="title-emoji">🍺</span></h1>
            <Link to="/item/all">
